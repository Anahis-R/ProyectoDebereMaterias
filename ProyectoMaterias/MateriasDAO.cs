...
namespace ProyectoMaterias
{
    ...
    {
        public static string cadenaConexion = @"Server=LAPTOP-ACMMVUIM\SQLEXPRESS; database=Materias; integrated security=true";
        ...
        public static DataTable getAll()
        {
            ...
            string sql = "select codMaterias, nombreMateria, nivel, carrera" + " from Materias";
        ...
        public static int actualizar(Materias mate)
        {
            ...
            string sql = "update Materias set  nombreMateria=@nombreMateria, nivel=@nivel, @carrera=@carrera "
